# Aqui estão as regras de negocio
...
class ProductCreator():
    ...
    def create(self, http_request: HttpRequest) -> HttpResponse:
        body = http_request.body # Pega a informação do body de http_request
    ...
    def __insert_product_in_sql(self, name: str, price: float, quantity: int) -> None: # tipagem dos elementos para deixar mais claro
    ...
    def __insert_in_cache(self, name: str, price: float, quantity: int) -> None:
        ...
        self.__redis_repo.insert_expiration(product_key, value, ex=60) # chave, valor e tempo de expiração
